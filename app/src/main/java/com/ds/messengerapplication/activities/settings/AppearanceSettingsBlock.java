...
public class AppearanceSettingsBlock extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        try {
            ...
            progressDialog = new LoadingDialog(this, getString(R.string.wait_for_it));
    ...
    private void initSettingsStates() {
        try {
            ...
            DatabaseValuesGetter.findValue(userId, Constants.USER_USE_SOUNDS_REFERENCE_PATH, this, result -> {
                useSoundsCheckBox.setChecked(Boolean.parseBoolean(result));
